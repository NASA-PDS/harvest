...
/**
 * Filters files using supplied wildcard(s). Based on the Apache WildcardFilter
 * class in the Commons IO package. Difference is that in this class, it uses
 * the org.apache.commons.io.FilenameUtils.wildcardMatchOnSystem() for its
 * matching rules, which means that pattern matching using this class is OS
 * dependent (case-insensitive on Windows and case-sensitive on Unix, Linux,
 * MAC)
 *
 * @author mcayanan
 * @version $Revision$
