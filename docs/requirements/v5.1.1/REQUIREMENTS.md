...
This requirement is not impacted by the current version
## As a user, I want to load compressed subsets of files into the Registry ([#240](https://github.com/NASA-PDS/harvest/issues/240)) 


This requirement is not impacted by the current version
## As a data loader, I want to disable checking for adjacent source products ([#245](https://github.com/NASA-PDS/harvest/issues/245)) 
...
This requirement is not impacted by the current version
## As a user, I want clearer per-product success/failure logging during harvest ([#322](https://github.com/NASA-PDS/harvest/issues/322)) 
